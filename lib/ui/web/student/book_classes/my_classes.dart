// ignore_for_file: unused_element, unused_local_variable, sized_box_for_whitespace, avoid_web_libraries_in_flutter, unused_import, unnecessary_null_comparison
                                    ...
                                    : enrolledlist.isNotEmpty
                                        ? Consumer<List<Schedule>>(builder:
                                            ...
                                            return Container(
                                                                    ...
                                                                    child: Align(
                                                                        ...
                                                                        child: Text(
                                                                          enrolledlist[index]
                                                                              .status,
                                                                          style:
                                                                              TextStyle(color: enrolledlist[index].status == 'Cancelled' ? classStatuscolor[2] : kColorGrey),
                                                                        )))),
                                                          ),
                                                          DataCell(ListTile(
                                                            contentPadding:
                                                            ...
                                                            subtitle: enrolledlist[
                                                                            index]
                                                                        .status ==
                                                                    'Cancelled'
                                                                ?  Text(
                                                                    'Cancelled Classes', style: TextStyle(color: classStatuscolor[2]),)
                                                                : Text(
                                              ...
                                              //                           .format(enrolledlist[index].dateEnrolled)
                                              //                           .toString(),
                                              //                       style: const TextStyle(
                                              //                           fontSize:
                                              //                               16,
