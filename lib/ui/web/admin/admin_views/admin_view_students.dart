...
class ViewStudentPersonalInfo extends StatefulWidget {
  ...
  const ViewStudentPersonalInfo({
    super.key,
    required this.data,
  });

  @override
  State<ViewStudentPersonalInfo> createState() =>
      _ViewStudentPersonalInfoState();
}

class _ViewStudentPersonalInfoState extends State<ViewStudentPersonalInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    profileurl = widget.data.profilelink;
    _updateResponse();
                            ...
                            child: Align(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${widget.data.studentFirstname} ${widget.data.studentMiddlename == 'N/A' ? '' : widget.data.studentMiddlename} ${widget.data.studentLastname}',
                            ...
                            child: Column(
                              children: [
                                ...
                                viewClassState == false
                                    ? Column(
                                        children: <Widget>[
                                          // guardianinfo.isNotEmpty
                                          //     ?
                                              // final guardiandata = guardianinfo.first;
                                              // confirstname.text = guardianinfo.first.guardianFirstname;
                                              // conmiddlename.text = guardianinfo.first.guardianMiddlename;
                                              // conlastname.text = guardianinfo.first.guardianLastname;
                                              // concountry.text = guardianinfo.first.country;
                                              // conaddress.text = guardianinfo.first.address;
                                              // conemailadd.text = guardianinfo.first.email;
                                              // concontact.text = guardianinfo.first.contact;
                                              // Padding(
                                              //     padding:
                                              ...
                                              //                               //   updateGuardianInfo('XuQyf7S8gCOJBu6gTIb0', guardianinfo.first.docID, confirstname.text, conmiddlename.text, conlastname.text, concontact.text, conemailadd.text, conaddress.text, concountry.text);
                                              //                               // } else {
                                              //                               //   return;
                                              //                               // }
                                              //                             });
                                              ...
                                              Container(
                                                  ...
                                                  child: const Center(
                                                    child:
                                                       Text('Guardian Information not Required!'),
                                                  ),
                                                )
                                        ],
                                      )
